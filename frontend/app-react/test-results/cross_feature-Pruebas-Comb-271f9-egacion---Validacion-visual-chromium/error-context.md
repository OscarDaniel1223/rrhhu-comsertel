...
Call log:
  - waiting for locator('button:has-text("Modo Claro"), button:has-text("Modo Oscuro")')
    - locator resolved to <button class="mt-3 w-full py-2 px-4 rounded-lg border border-blue-600 text-blue-600 hover:bg-blue-50 hover:text-blue-700 font-semibold transition-colors flex items-center justify-center gap-2 cursor-pointer">…</button>
