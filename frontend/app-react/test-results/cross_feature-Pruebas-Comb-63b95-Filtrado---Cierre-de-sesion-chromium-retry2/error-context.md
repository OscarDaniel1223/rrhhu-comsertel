...
- Name: cross_feature.spec.js >> Pruebas Combinadas de Caracteristicas Tier 3 >> T3.3: Login -> Empleados -> Filtrado -> Cierre de sesion
- Location: frontend/app-react/tests/e2e/cross_feature.spec.js:194:3
