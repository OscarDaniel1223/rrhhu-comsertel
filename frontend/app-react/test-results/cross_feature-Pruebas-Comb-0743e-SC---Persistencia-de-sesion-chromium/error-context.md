...
- Name: cross_feature.spec.js >> Pruebas Combinadas de Caracteristicas Tier 3 >> T3.4: Login -> Modales multiples -> Cierre con ESC -> Persistencia de sesion
- Location: frontend/app-react/tests/e2e/cross_feature.spec.js:208:3
