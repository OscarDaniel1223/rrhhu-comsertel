...
- Name: employees.spec.js >> Pruebas de Empleados F3 >> Caso 1: Visualizacion de la lista de colaboradores
- Location: frontend/app-react/tests/e2e/employees.spec.js:114:3
...
Call log:
  - waiting for locator('button:has-text("Empleados")')
    2 × locator resolved to <button class="flex items-center w-full px-5 py-2.5 text-sm font-medium transition-colors text-slate-600 hover:bg-slate-50 hover:text-slate-900">…</button>
