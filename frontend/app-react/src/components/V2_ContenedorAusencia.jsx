...
import V2_TablaAusencia from './V2_TablaAusencia';
      ...
      <div className="mb-8 flex justify-center">
        <nav className="flex space-x-2 bg-slate-100 dark:bg-slate-800 p-1.5 rounded-[15px]" aria-label="Tabs">
          <button
            ...
            className={`whitespace-nowrap py-2.5 px-6 rounded-[15px] font-medium text-sm transition-all duration-300 cursor-pointer ${
              activeTab === 'tabla'
