...
Error: strict mode violation: locator('text=Estadísticas') resolved to 2 elements:
    1) <h2 class="fw-bold mb-1">Estadísticas</h2> aka getByRole('heading', { name: 'Estadísticas' })
    2) <p class="mb-0">Aquí puedes ver estadísticas generales.</p> aka getByText('Aquí puedes ver estadísticas')
