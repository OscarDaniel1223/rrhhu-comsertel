...
- Name: dashboard.spec.js >> Pruebas de Dashboard F2 >> Caso 5: Carga de tabla de resenas de este mes
- Location: frontend/app-react/tests/e2e/dashboard.spec.js:133:3
...
Locator: locator('text=Reseñas de este mes')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Reseñas de este mes')
