...
- Name: dashboard.spec.js >> Pruebas de Dashboard F2 >> Caso 7: Menu y dashboard adaptados a pantalla movil (320px)
- Location: frontend/app-react/tests/e2e/dashboard.spec.js:149:3
...
Locator: locator('div.fixed.top-0.left-0.h-screen.w-64')
Expected pattern: /translate-x-full/
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveClass" with timeout 5000ms
  - waiting for locator('div.fixed.top-0.left-0.h-screen.w-64')
