...
- Name: dashboard.spec.js >> Pruebas de Dashboard F2 >> Caso 3: Grafico Top 5 categorias mas vendidas este mes visible
- Location: frontend/app-react/tests/e2e/dashboard.spec.js:121:3
...
Locator: locator('text=Top 5 categorias mas vendidas este mes')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Top 5 categorias mas vendidas este mes')
