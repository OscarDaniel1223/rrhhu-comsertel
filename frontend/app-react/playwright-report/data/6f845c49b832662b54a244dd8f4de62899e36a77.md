...
- Name: dashboard.spec.js >> Pruebas de Dashboard F2 >> Caso 2: Grafico Ventas ultimos 3 meses visible
- Location: frontend/app-react/tests/e2e/dashboard.spec.js:115:3
...
Locator: locator('text=Ventas ultimos 3 meses')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Ventas ultimos 3 meses')
